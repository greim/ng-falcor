 ...
 * `ngf.refresh(pathSet, millis)` - Reload the given pathSet from the datasource and pause falcor-related digest updates during the update. Optionally, `millis` will control how long to pause digest updates.
